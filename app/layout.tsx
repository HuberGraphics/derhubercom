...
const jsonLd = {
  ...
  description:
    "Professionelles Webdesign und Webentwicklung für kleine Unternehmen in Heidelberg und dem Rhein-Neckar-Kreis.",
  url: "https://derhuber.com",
  logo: "https://derhuber.com/images/logo.png",
  telephone: "+4915129515056",
  ...
  sameAs: ["https://www.linkedin.com/in/derhuber"],
  hasOfferCatalog: {
    "@type": "OfferCatalog",
    ...
    itemListElement: [
      {
        ...
        itemOffered: {
          ...
          name: "Webdesign",
          description:
            "Professionelles Webdesign für moderne, responsive Websites",
        },
      },
      {
        "@type": "Offer",
      ...
      },
      {
        ...
        itemOffered: {
          ...
          name: "UX-Design",
          description:
            "Nutzerfreundliche Websites die Besucher zu Kunden machen",
        },
      },
    ],
  },
